...
namespace AOC2019_7
{
    public class InstructionSet
    {
        ...
        public int Execute(int testIteration, int index, bool incInstructionPtr, out int? output, out bool inputCodeUsedInExecution, int inputValue = 0)
        {
            inputCodeUsedInExecution = false;
            ...
            switch (this.OpCode.OpCodeValue)
            {
                ...
                case OpCodeValue.LessThan:
                    if (inputParams[0] < inputParams[1])
                        this.Input[outputParams[0]] = 1;
                    else
                        this.Input[outputParams[0]] = 0;
                    break;
